...
while(k--){
	...
	if(point%m==0)
	xcordinate=point/m;
	else xcordinate=((point/m))+1;
	double ycordinate=(point-xcordinate*m+m-1)+1;
//	cout<<xcordinate<<" "<<ycordinate<<endl;
	ans+=xcordinate*ycordinate*(n-xcordinate+1)*(m-ycordinate+1);
